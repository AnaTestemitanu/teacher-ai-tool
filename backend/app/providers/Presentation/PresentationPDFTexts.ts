export const PDFText = `The relativistic character of the laws of physics began to be apparent very early
...
of reference moving with constant velocity relative to each other. Contrary to popular opinion, the special theory is not difficult to understand. Its consequences, which
...
is of great importance in cosmology and in understanding events that occur in the 1-1 The Experimental Basis of Relativity
...
measurements of space and time could be made. Two such inertial frames are illustrated in Figure 1-1, arranged so that corresponding axes in S and are parallel and
S moves in the direction at velocity x v for an observer in S (or S moves in the x direction at velocity for an observer in ). Figures 1-2 and 1-3 illustrate the conceptual differences between inertial and noninertial reference frames. Transformation
